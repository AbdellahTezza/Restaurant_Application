<template>
  <HeaderView />
  <!-- <h1>Hello {{ name }}, Welcome to page home</h1> -->
  <!-- ////// -->
          ...
          <div class="col-sm-12">
            <div class="card">
              <div class="card-header d-flex justify-content-between">
                ...
                <router-link to="/add" class="btn btn-sm btn-icon btn-success" data-toggle="tooltip" data-placement="top" title="" data-original-title="Add" >
                      ...
                      <tr v-for="(item, index) in restaurants" :key="item.id">
                        ...
                        <td>
                          ...
                          <div class="flex align-items-center list-user-action">
                                 ...
                                 <router-link :to="'/update/' + item.id" class="btn btn-sm btn-icon btn-warning" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit" >
                                    <span class="btn-inner">
                                 ...
                                 <a @click="deleterestaurant(item.id)" class="btn btn-sm btn-icon btn-danger" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete" href="#">
                                    <span class="btn-inner">
